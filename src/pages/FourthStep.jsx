...
function FourthStep() {
  ...
  return (
    <div className="relative flex flex-col items-start gap-5 w-1/3 mt-12 justify-between">
      ...
      <div className=" w-full flex justify-between mt-5">
        <Link to="/threestep" className="text-[#9699AA] px-3 py-4">
          Go Back
        </Link>
        <button
          onClick={handleConfirm}
          className="bg-denim px-6 py-4 text-white font-bold rounded-lg"
        >
          Confirm
        </button>
      </div>
